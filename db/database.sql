...
CREATE TABLE University(
	...
	about TEXT, # Little text with a description of this University
	address VARCHAR(200),
...
CREATE TABLE Program(
	id INT NOT NULL AUTO_INCREMENT,
	name VARCHAR(100) NOT NULL,
	about TEXT, # Little text with a description of this Program
...
CREATE TABLE Course(
	id INT NOT NULL AUTO_INCREMENT,
	name VARCHAR(100) NOT NULL,
	about TEXT, # Little text with a description of this Course
...
CREATE TABLE Student(
	...
	about VARCHAR(250), # Little text with a description of this Student
